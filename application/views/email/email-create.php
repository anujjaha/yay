...
<div class="row">
<div class="col-md-12">
	<a href="<?php echo base_url();?>email/create">
		Add Email Details
	</a>
	</div>
</div>
...
<div class="box">
	...
	<form method="POST" action="<?php echo base_url();?>email/save">
	 ...
	 <div class="form-group row">
  	...
  	<div class="form-group row">
	    <label for="email_id" class="col-sm-2 col-form-label">
	    Email Id:
		</label>
	    <div class="col-sm-10">
  	...
  	<div class="form-group row">
	    <label for="cc" class="col-sm-2 col-form-label">
	    CC:
		</label>
	    <div class="col-sm-10">
  	...
  	<div class="form-group row">
	    <label for="bcc" class="col-sm-2 col-form-label">
	   BCC:
		</label>
	    <div class="col-sm-10">
  	...
  	<div class="form-group row">
	    <label for="reply_to" class="col-sm-2 col-form-label">
	    Reply to:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="reply_to" name="reply_to" placeholder="reply_to">
	    </div>
  	</div>
	...
	<div class="form-group row">
  	...
  	<!-- <div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="attachments" name="attachments" placeholder="attachments">
	    </div>
  	</div> -->

	<button type="submit" name="submit" class="btn btn-primary mb-2" value="Save">Sent</button>
...
<script type="text/javascript">
	function loadCompany() 
	{
		...
		$.ajax(
		{
			url: "<?php echo base_url();?>user/getCompanyInfo",
			method: "POST",
			dataType: "JSON",
			data: {
			...
			{
				console.log(data)
				$("#email_id").val(data.companyRec.email);
			},
			error: function (data) 
			{
				alert("Something Went Wrong !");
