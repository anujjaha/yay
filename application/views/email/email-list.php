	...
	<?php
		...
		?>
			<tr>
				...
				<td><?php echo $result['bcc'];?></td>
				<td><?php echo $result['status'];?></td>
				<td><?php echo $result['read'];?></td>
				<td><?php echo $result['clicks'];?></td>
				<td><?php echo $result['nickname'];?></td>
				<td><?php echo $result['sent_at'];?></td>
				<td><?php echo $result['attachments'];?></td>
				<td><?php echo $result['schedule_at'];?></td>
				<td><?php echo $result['created_at'];?></td>
				<td><?php echo $result['reply_to'];?></td>
				<td><a href="<?php echo base_url();?>email/delete?id=<?php echo $result['id'];?>">
						Delete
					</a>
				</td>
			</tr>
