	...
	<?php
		...
		?>
			<tr>
				...
				<td><?php echo $result['ceemail'];?></td>
				<td><?php echo $result['personal_email'];?></td>
				<td><?php echo $result['department'];?></td>
				<td><?php echo $result['mobile'];?></td>
				<td><?php echo $result['mobile2'];?></td>
											
				<td><a href="<?php echo base_url();?>cemployees/delete?id=<?php echo $result['id'];?>">
						Delete
					</a>
					||
					<a href="<?php echo base_url();?>cemployees/update?id=<?php echo $result['id'];?>">
						Update
					</a>
				</td>
			</tr>
