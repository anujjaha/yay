...
<div class="row">
<div class="col-md-12">
	<a href="<?php echo base_url();?>cemployees/create">
		Add Employess
	</a>
	</div>
</div>
...
<div class="box">
	...
	<form method="POST" action="<?php echo base_url();?>cemployees/save">
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ename" name="ename" placeholder="Employee Name">
	    </div>
  	</div>
  	...
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ceemail" name="ceemail" placeholder="Email">
	    </div>
  	</div>
  	...
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="personal_email" name="personal_email" placeholder="Personal Email">
	    </div>
  	</div>
	...
	<div class="form-group row">
  	...
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="mobile2" name="mobile2" placeholder="Mobile2">
	    </div>
  	</div>
