	...
	<div class="box-body table-responsive">
		...
		?>
			<tr>
				...
				<td><?php echo $result['gstn']; ?> </td>
				<td><?php echo $result['grate']; ?> </td>
				<td><?php echo $result['status']; ?> </td>

				<td><a href="<?php echo base_url();?>user/delete?id=<?php echo $result['id'];?>">
						Delete
					</a>
					||
					<a href="<?php echo base_url();?>user/update?id=<?php echo $result['id'];?>">
						Update
					</a>
				</td>
			</tr>
...
function downloadPDF()
{
	jQuery.ajax(
	{
		url: "<?php echo site_url();?>/user/downloadPDF",
		method: 'POST',
		dataType: 'JSON',
		data: {
		},
