    ...
    <body class="skin-blue">
       ...
       ?>
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <?php require_once('public_sidebar.php');?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        <?php echo $title ?? '';?>
                        <strong><small>Cybera Print Art - ONLINE ESTIMATION</small></strong>
                    </h1>

                    <div class="row">
                    <div class="col-md-12 text-center">
                        
                        <span class="pull-right mr-20" id="dealerLoginBtn">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#dealerLogin">
                              Dealer Login
                            </button>
                        </span>
                        <span class="pull-right mr-20" id="dealerContainer" style="display:none;">
                            
                        </span>
                    </div>  
                    <div class="col-md-12 text-center">
                        <span class="">
                            <button id="downloadBtn" style="display:none;" onclick="generatePDF()" class="btn btn-primary">Download</button>
                            <button id="mailBtn" style="display:none;" onclick="mailPDF()" class="btn btn-primary">Email</button>
                        </span>
                    </div>
                </div>
