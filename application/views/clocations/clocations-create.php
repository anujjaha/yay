...
<div class="row">
<div class="col-md-12">
	<a href="<?php echo base_url();?>clocations/create">
		Add Branch Details
	</a>
	</div>
</div>
...
<div class="box">
	...
	<form method="POST" action="<?php echo base_url();?>clocations/save">
	 ...
	 <div class="form-group row">
	    ...
	    <div class="col-sm-10">
			<select onchange="loadCompany()" name="company_id" id="company_id"  class="form-control" >
			<?php
	...
	<div class="form-group row">
	    <label for="ltitle" class="col-sm-2 col-form-label">
	    Branch Name:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ltitle" name="ltitle" placeholder="Branch Name">
	    </div>
  	</div>

  	<div class="form-group row">
	    <label for="branch_manager" class="col-sm-2 col-form-label">
	    Branch Manager Name:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="branch_manager" name="branch_manager" placeholder="Branch Manage Name">
	    </div>
  	</div>

  	<div class="form-group row">
	    <label for="ladd1" class="col-sm-2 col-form-label">
	    Branch Address1:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ladd1" name="ladd1" placeholder="Branch Address1">
	    </div>
  	</div>

  	<div class="form-group row">
	    <label for="ladd2	" class="col-sm-2 col-form-label">
	    Branch Address2:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="ladd2" name="ladd2" placeholder="Branch Address2">
	    </div>
  	</div>
  	<div class="form-group row">
	    <label for="lcity	" class="col-sm-2 col-form-label">
	    City:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="lcity" name="lcity" placeholder="City">
	    </div>
  	</div>
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="lstate" name="lstate" placeholder="State">
	    </div>
  	</div>
  	<div class="form-group row">
	    <label for="lpin" class="col-sm-2 col-form-label">
	    Pincode:
		</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="lpin" name="lpin" placeholder="Pincode">
	    </div>
  	</div>
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="lmobile1" name="lmobile1" placeholder="Mobile1">
	    </div>
  	</div>
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="lmobile2" name="lmobile2" placeholder="Mobile2">
	    </div>
  	</div>
  	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="text" class="form-control" id="google_map" name="google_map" placeholder="G Map">
	    </div>
  	</div>
  	<div class="form-group row">
	    <label for="lemail" class="col-sm-2 col-form-label">
	    Email:
		</label>
	    <div class="col-sm-10">
