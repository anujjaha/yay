	...
	<?php
		...
		?>
			<tr>
				...
				<td><?php echo $result['ltitle'];?></td>
				<td><?php echo $result['branch_manager'];?></td>
				<td><?php echo $result['ladd1'];?></td>
				<td><?php echo $result['ladd2'];?></td>
				<td><?php echo $result['lcity'];?></td>
				<td><?php echo $result['lstate'];?></td>
				<td><?php echo $result['lpin'];?></td>
				<td><?php echo $result['lmobile1'];?></td>
				<td><?php echo $result['lmobile2'];?></td>
				<td><?php echo $result['google_map'];?></td>
				<td><?php echo $result['lemail'];?></td>
											
				<td><a href="<?php echo base_url();?>clocations/delete?id=<?php echo $result['id'];?>">
						Delete
					</a>
					||
					<a href="<?php echo base_url();?>clocations/update?id=<?php echo $result['id'];?>">
						Update
					</a>
				</td>
			</tr>
